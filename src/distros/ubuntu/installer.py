...
#   Modify OS release information (optional)
    os.system(f"sudo sed -i '/^NAME/ s/Ubuntu/Ubuntu (ashos)/' /mnt/etc/os-release")
    os.system(f"sudo sed -i '/PRETTY_NAME/ s/Ubuntu/Ubuntu (ashos)/' /mnt/etc/os-release")
    os.system(f"sudo sed -i '/^ID/ s/debian/ubuntu_ashos/' /mnt/etc/os-release")
