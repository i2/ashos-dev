...
#   GRUB and EFI
###DONE MANUALLY    os.system(f"sudo chroot /mnt sudo /usr/sbin/grub-install {args[2]}")
###DONE MANUALLY    os.system(f"sudo chroot /mnt sudo grub-mkconfig {args[2]} -o /boot/grub/grub.cfg")
