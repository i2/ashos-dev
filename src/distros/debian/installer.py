...
#   Copy astpk
    ...
    os.system("sudo cp -a ./src/detect_os.sh /mnt/usr/bin/detect_os.sh")
###    os.system("sudo chroot /mnt chmod a+x /usr/sbin/ast /usr/bin/detect_os.sh") # Might not be necessary by 'cp -a'
